package com.itheima.hospitalregistration.frame;

import com.itheima.hospitalregistration.bean.Appointment;
import com.itheima.hospitalregistration.bean.Department;
import com.itheima.hospitalregistration.bean.Doctor;
import com.itheima.hospitalregistration.bean.Schedule;
...
public class HosptialManger {
    ...
    public void start(){
        ...
        System.out.println("6、医生管理-展示全部医生的坐诊情况（当前和未来6天的坐诊详情）");
            ...
            for (int j = 0; j < doctors.size(); j++) {
                ...
                for (int k = 0; k < schedules.size(); k++) {
                    ...
                    if (schedule.isMorning()){
                        System.out.println("上午 " + schedule.getMstart() + "-"
                    ...
                    if (schedule.isAfternoon()){
                        System.out.println("下午 " + schedule.getAstart() + "-"
